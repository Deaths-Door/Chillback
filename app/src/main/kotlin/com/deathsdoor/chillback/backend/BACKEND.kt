...
private inline fun <reified Lib : Library> loadIndirect(
    ...
    return Native.loadLibrary(findLibraryName(componentName), Lib::class.java) as Lib
}
...
sealed class YoutubeException: Exception() {
    class Download(val `_`: kotlin.String) : YoutubeException() {
        override val message get() = "=${ `_` }"
    }

    class Video(val `_`: kotlin.String) : YoutubeException() {
        override val message get() = "=${ `_` }"
    }

    class Proxy(val `_`: kotlin.String) : YoutubeException() {
        override val message get() = "=${ `_` }"
    }
