...
// Copied from https://github.com/russhwolf/multiplatform-settings/blob/1.2/ branch as 1.2 is not yet released
 ...
 */
@JvmInline
internal value class Listener(private val removeListener: () -> Unit) : SettingsListener {
