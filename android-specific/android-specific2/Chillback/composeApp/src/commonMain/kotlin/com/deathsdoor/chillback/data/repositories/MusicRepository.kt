...
import com.deathsdoor.chillback.data.music.MediaMetadataExtractor

class MusicRepository(internal val coroutineScope : CoroutineScope) {
    private val tracksDetails = Cache.Builder<Uuid, TrackDetails>()
        .maximumCacheSize(50)
